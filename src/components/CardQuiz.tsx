    ...
    <div className='flex flex-col bg-white p-4 rounded border border-gray-200 md:col-span-12 lg:col-span-6 xl:col-span-4 h-[380px]' >
        ...
        <div className='flex flex-col items-center mt-2 gap-1' >
            <div className='flex items-center gap-2 border border-gray-300 px-3 rounded py-1' >
                <div className={`flex items-center justify-center rounded-full text-white h-[20px] w-[20px] ${props.quiz.respuestas['pregunta_1'] ? 'bg-green-500':'bg-red-600'}`}>
                    {props.quiz.respuestas['pregunta_1'] ? <CircleCheck /> : <CircleX/>}
                </div>
                <span>
                    Pregunta 1
                </span>
            ...
            <div className='flex items-center gap-2 border border-gray-300 px-3 rounded py-1' >
                <div className={`flex items-center justify-center rounded-full text-white h-[20px] w-[20px] ${props.quiz.respuestas['pregunta_2'] ? 'bg-green-500':'bg-red-600'}`}>
                    {props.quiz.respuestas['pregunta_2'] ? <CircleCheck /> : <CircleX/>}
                </div>
                <span>
                    Pregunta 2
                </span>
            ...
            <div className='flex items-center gap-2 border border-gray-300 px-3 rounded py-1' >
                <div className={`flex items-center justify-center rounded-full text-white h-[20px] w-[20px] ${props.quiz.respuestas['pregunta_3'] ? 'bg-green-500':'bg-red-600'}`}>
                    {props.quiz.respuestas['pregunta_3'] ? <CircleCheck /> : <CircleX/>}
                </div>
                <span>
                    Pregunta 3
                </span>
            ...
            <div className='flex items-center gap-2 border border-gray-300 px-3 rounded py-1' >
                <div className={`flex items-center justify-center rounded-full text-white h-[20px] w-[20px] ${props.quiz.respuestas['pregunta_4'] ? 'bg-green-500':'bg-red-600'}`}>
                    {props.quiz.respuestas['pregunta_4'] ? <CircleCheck /> : <CircleX/>}
                </div>
                <span>
                    Pregunta 4
                </span>
