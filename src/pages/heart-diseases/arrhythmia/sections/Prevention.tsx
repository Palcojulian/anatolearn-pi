  ...
  return (
    <div className="flex flex-col gap-2">
      <p className="text-start" >
        ...
        la salud del corazón y prevenir alteraciones en su ritmo.
      </p>
      <h6 className="text-start">Recomendaciones</h6>
      <ul className="list-disc ps-6 space-y-2">
        <li>
          <p className="text-start">
            <b>Mantener una dieta saludable y equilibrada: </b>
            Consumir alimentos ricos en nutrientes, como frutas, verduras, granos enteros y proteínas magras, ayuda a mantener un corazón fuerte y a controlar factores de riesgo como el colesterol alto y la hipertensión.
          </p>
        </li>
        <li>
          <p className="text-start">
            <b>Ejercicio regular: </b>
        ...
        <li>
          <p className="text-start">
            <b>No fumar: </b>
            Fumar daña los vasos sanguíneos y el corazón, aumentando significativamente el riesgo de trastornos del ritmo cardíaco y enfermedades cardiovasculares.
          </p>
        </li>
