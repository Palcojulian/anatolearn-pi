...
const ColonaryCase_Tratamiento = (props: JSX.IntrinsicElements["group"] & { color?: string }) => {
  const group = useRef<THREE.Group>(null);
  const { scene, animations } = useGLTF("/models-3d/ColonaryCase_Tratamiento.glb");
...
export default ColonaryCase_Tratamiento;

useGLTF.preload("/models-3d/ColonaryCase_Tratamiento.glb"); 