...
import Medalla from "../../../../../public/img/medalla-de-oro.png";

const FirstPosition = (props: Ranking) => {

  return (
    <Html occlude center position={[0, 0.75, 0.6]} transform distanceFactor={4}>
      <div className="relative flex flex-col justify-center gap-3 items-center w-[130px] h-[170px] rounded-lg shadow-[-4px_4px_56px_-4px_#ffbf00]">
