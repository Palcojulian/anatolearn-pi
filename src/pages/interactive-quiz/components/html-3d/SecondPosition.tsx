...
import Medalla from "../../../../../public/img/medalla-de-plata.png";

const SecondPosition = (props: Ranking) => {

  return (
    <Html occlude center position={[-2, 0.58, 0.6]} transform distanceFactor={4}>
      <div className="relative flex flex-col justify-center gap-3 items-center w-[130px] h-[170px] rounded-lg shadow-[-4px_4px_56px_-4px_#c0c0c0]">
        ...
        <div className="flex gap-2">
          ...
          <div className="w-full flex flex-col gap-1  items-center">
            ...
            <div className="text-[10px] bg-white px-1 rounded text-gray-700 font-medium ">SENGUNDOS</div>
          </div>
        </div>
        <img 
